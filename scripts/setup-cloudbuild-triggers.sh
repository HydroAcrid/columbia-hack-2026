...
VISITOR_BUDGET_BYPASS_IDS="${VISITOR_BUDGET_BYPASS_IDS:-}"
...
ensure_trigger \
  ...
  "_SERVICE_NAME=${AGENT_SERVICE_NAME},_REGION=${REGION},_AR_REPOSITORY=${AR_REPOSITORY},_IMAGE_TAG=latest,_GEMINI_SECRET_NAME=gemini-api-key,_DEEPGRAM_SECRET_NAME=deepgram-api-key,_SESSION_STORE_BACKEND=firestore,_VERTEX_LOCATION=${REGION},_VERTEX_MODEL=${VERTEX_MODEL},_VERTEX_LIVE_MODEL=${VERTEX_LIVE_MODEL},_LIVE_BATCH_IDLE_MS=${LIVE_BATCH_IDLE_MS},_LIVE_BATCH_MAX_MS=${LIVE_BATCH_MAX_MS},_LIVE_MIN_MEANINGFUL_WORDS=${LIVE_MIN_MEANINGFUL_WORDS},_LIVE_CONTEXT_TRANSCRIPT_LINES=${LIVE_CONTEXT_TRANSCRIPT_LINES},_LIVE_CONTEXT_NODE_LIMIT=${LIVE_CONTEXT_NODE_LIMIT},_LIVE_CONTEXT_EDGE_LIMIT=${LIVE_CONTEXT_EDGE_LIMIT},_VISITOR_BUDGET_BYPASS_IDS=${VISITOR_BUDGET_BYPASS_IDS}"
